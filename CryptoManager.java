...
public class CryptoManager {
		...
		// check if the parameter String plainText is in the range to be 
		//	allow bounds of ASCII code.
			//if plaintext is in the range return true
		...
		public static String encryptCaesar(String plainText, int key) {
			// The parameter plainText is an uppercase string to be encrypted.
					//The parameter key is an integer that specifies the offset of each character.
			//@avenir t
		...
		//This is the inverse of the encryptBellaso method.
		{
			String decryptedText ="";
			 int bellasoStrLength = bellasoStr.length();
